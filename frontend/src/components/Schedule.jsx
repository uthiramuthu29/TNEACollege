import { SubHeading } from "../resuableChunks/Typography";
  ...
  return (
    <div className="schedule mb-8 ">
      ...
      <div className="active-upcoming border border-ash-border rounded-xl  ">
        <div className="flex items-center gap-4 bg-[#F1F4F6] rounded-xl px-4 py-5.5   ">
          ...
          <p className="text-[10px] leading-5 font-inter font-bold text-dark-green bg-light-green rounded-lg px-2 py-1 ml-auto " >Active</p>
        </div>
        <ul className="p-4 bg-[#EBEEF0] rounded-xl  " >
