...
export default function CutoffCalculator() {
    return (
        <div className="bg-white border border-ash-border rounded-xl p-6 " >
            <div className="mb-6 ">
            ...
            <div className="score bg-navy-dark rounded-xl p-8 ">
                ...
                <p className="text-[14px] leading-5 font-normal font-inter text-[#86A0CD] mb-6 text-center  ">Based on standard TNEA weightage
                    formula.</p>
                <button className="flex items-center gap-4  text-[16px] leading-7 font-bold font-inter text-center text-navy-dark bg-white px-8 py-4 rounded-lg  " >
                    <Search size={22} />
                    Find Best Matching
                    Colleges
                </button>
